...
export default function TermsAndConditionsContent() {
  return (
    <div className="max-w-[979px] py-8 space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4 text-base md:text-lg leading-relaxed text-[#080808]">
          <p>
            ...
            law), cryptoassets, and Central Bank Digital Currencies (CBDCs), all
            taking place through a barter mechanism. Our platform integrates
            seamlessly with various financial systems, providing users with a
            fast, low-cost, and reliable way to make payments, conduct commerce,
            and manage transactions globally.
          </p>
          <p>
            Users acknowledge that the value of cryptoassets and virtual assets
            is highly volatile. Transactions involving cryptoassets carry a risk
            of partial or total loss. Users accept these risks fully and
            voluntarily.
          </p>
          <p>
          ...
          <p>
            ...
            These measures protect users from fraud, unauthorized access, and
            financial crime.
          </p>
          <p>
        ...
        <div className="space-y-4 text-base md:text-lg leading-relaxed text-[#080808]">
          <ul className="space-y-3">
            ...
            <li>
              ...
              by blockchain technology, including but not limited to Bitcoin
              (BTC), Ethereum (ETH), stablecoins, and other supported tokens.
            </li>
            <li>
              <strong>Fiat Currency:</strong> Government-issued currency such as
              USD, EUR, GBP, INR, and others, which are legally recognized as
              money.
            </li>
            <li>
              <strong>Central Bank Digital Currency (CBDC):</strong> A digitized
              version of a nation&apos;s fiat currency, issued and regulated by a
              central bank.
            </li>
            <li>
            ...
            <li>
              <strong>Wallet:</strong> A digital tool that stores cryptoassets
              and allows users to send, receive, and manage their funds.
            </li>
            <li>
              <strong>P2P Transactions (Peer-to-Peer Payments):</strong> A
              direct transfer of funds between two users, enabling seamless
              crypto-to-crypto or crypto-to-fiat exchanges.
            </li>
            <li>
              <strong>Decentralized Finance (DeFi):</strong> A blockchain-based
              financial ecosystem that operates without traditional banks,
              allowing users to lend, borrow, and trade digital assets.
            </li>
            <li>
              <strong>Blockchain:</strong> A decentralized, distributed ledger
              technology that records all cryptocurrency transactions securely
              and transparently.
            </li>
            <li>
              <strong>Regulatory Compliance:</strong> Adherence to legal
              requirements, financial guidelines, and government policies
              governing digital payments and cryptocurrency transactions.
            </li>
            <li>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4 text-base md:text-lg leading-relaxed text-[#080808]">
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <li>
              Not be located in restricted jurisdictions (e.g., North Korea,
              Iran, Myanmar, Russia) or unsupported jurisdictions (check the
              website before your onboarding or any funds/cryptoasset transfer).
            </li>
            <li>
              Provide necessary KYC/KYB documentation and pass the verification
              as per the applicable law and guidelines of the state in question.
            </li>
          </ul>
        </div>
      </section>

      {/* Section 4: User Account Registration */}
      <section className="space-y-6">
        <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-6">
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Users can send and receive payments using fiat currency (where
                  allowed by law and upon full compliance with the required
                  standards, registrations, and authorizations), cryptoassets
                  (Bitcoin, Ethereum, compliant stablecoins), and Central Bank
                ...
                <li>
                  Users can convert digital assets into fiat and vice versa,
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Merchants receive real-time transaction analytics and
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Recurring payments can be customized based on frequency and
                  transaction limits.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  NFC-enabled payments are supported for contactless in-store
                  purchases, improving transaction speed.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Users can escalate unresolved disputes through the platform&apos;s
      ...
      {/* Section 6: User Registration Process (SOPs) */}
      <section className="space-y-6">
        <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-6">
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Complete the registration form with accurate personal or
                business details.
              </li>
              <li>
                Undergo KYC verification by providing government-issued
                identification, proof of address, and any other requested
                documents.
              </li>
              <li>
                Maintain up-to-date information and promptly update any changes
                in personal or business details.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Crypto transactions are typically processed within minutes,
                subject to blockchain network conditions.
              </li>
              <li>
                Fiat transactions may take 1-5 business days, depending on the
                banking network and jurisdiction.
              </li>
              <li>
                Users must verify all payment details before confirming
                transactions, as cryptocurrency transactions are irreversible.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Safeguard their private keys, passwords, and personal account
                credentials.
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <p>
              In the event of a failed transaction, incorrect payment, or
              dispute, users should:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
              ...
              <li>
                Provide necessary details, including transaction ID, wallet
                address, and any supporting documents.
              </li>
              <li>
                Await investigation results, which may take 5-10 business days,
      ...
      {/* Section 7: Intellectual Property Rights (IPRs) */}
      <section className="space-y-6">
        <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-6">
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                This license does not confer ownership rights over any part of
                the platform.
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Reverse engineering or attempting to derive the platform&apos;s
                source code.
              </li>
              <li>
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Users must complete KYC verification before accessing certain
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Users must provide government-issued identification, proof of
                address, and other verification documents during registration.
              </li>
              <li>
                Business accounts may require additional documentation, such as
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Users must report any unauthorized transactions or suspicious
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                All user data is protected with bank-grade encryption (AES-256)
              ...
              <li>
                Transactions are processed through a secure blockchain
                infrastructure, ensuring immutability and transparency.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                ...
                irreversible and must verify payment details before initiating
                transfers.
              </li>
              <li>
              ...
              <li>
                Users must secure their private keys and account credentials to
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4 text-base md:text-lg leading-relaxed text-[#080808]">
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li>
              Transaction fees apply based on network conditions and processing
              requirements.
            </li>
            <li>
              <span className="font-semibold">bepay</span> reserves the right to
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                ...
                <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                  <li>
                    Loss of profits, revenue, business opportunities, or
                    goodwill.
                  </li>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                ...
                <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                  ...
                  <li>
                    Internet or network failures, cyberattacks, or unexpected
                    blockchain malfunctions.
                  </li>
                </ul>
              </li>
            </ul>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Engaging in money laundering, tax evasion, terrorism financing,
                or fraud.
              </li>
              <li>
                Conducting transactions related to stolen assets, illicit drugs,
          ...
          <div className="space-y-4">
            ...
            <p>
              Users must not engage in activities that disrupt the integrity of
              cryptocurrency markets, including:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Pump-and-dump schemes, wash trading, spoofing, or price
                manipulation.
              </li>
              <li>
                Exploiting system vulnerabilities or attempting
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Users must not create multiple accounts to circumvent
                transaction limits, verification requirements, or platform
                policies.
              </li>
              <li>
                Impersonation of any individual, company, or entity is strictly
                forbidden.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Any abuse of promotional offers, referral programs, or rewards
                systems will result in account suspension and potential
                financial penalties.
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                ...
                <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                  <li>Settle all pending transactions.</li>
                  <li>Withdraw any remaining funds from their wallet.</li>
                  <li>
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              required by applicable law, regulatory instruction, or internal
              compliance policies. Also, we reserve the right to suspend or
              terminate user accounts under the following conditions:
            </p>
            ...
            <div className="space-y-4 ml-4">
              ...
              <p>
                If a user breaches any clauses outlined in this agreement,
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>
                  Accounts with incomplete or outdated KYC information may be
                  temporarily restricted until compliance requirements are met.
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Require additional security verifications.</li>
                <li>
                  Permanently close the account if illegal activities are
                  confirmed.
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Be required to withdraw any remaining funds within a stipulated
                period (if applicable).
              </li>
              <li>
                Have limited rights to dispute or appeal, except in cases where
                legal recourse is allowed.
              </li>
            </ul>
            <p>
              <span className="font-semibold">bepay</span> reserves the right to
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                ...
                accordance with the laws of Lithuania, without regard to
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                If no resolution is reached, the dispute shall be submitted to
                binding arbitration in the Netherlands, as per the arbitration
                rules of NCC in Amsterdam.
              </li>
              <li>
                Arbitration shall be conducted in English, unless agreed
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Any claim or dispute must be filed within one (1) year from the
                date of the event giving rise to the claim.
              </li>
              <li>
                If not filed within this period, the user waives their right to
                pursue legal action.
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Users may be required to provide additional information upon
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                ...
                <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                  <li>
                    Continuous platform availability (e.g., due to maintenance,
                    system upgrades, or technical failures).
                  </li>
                  <li>
                    Instant execution of transactions, as blockchain networks
                    and banking systems are subject to delays, congestion, or
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                ...
                <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                  <li>
                    Cryptoassets are volatile assets and may lose value rapidly.
                    Users may lose all of their funds. There is no deposit or
                  ...
                  <li>
                    There is no recourse for lost funds due to incorrect
                    transactions or forgotten private keys. All transactions are
                  ...
                  <li>
                    The user is fully obliged to comply in his country of
                    residence for tax matters and is responsible for such
                    matters.
                  </li>
                </ul>
              </li>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                ...
                <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                  <li>
                    Acts of God (natural disasters, pandemics, war, government
                    restrictions, economic collapse).
                  </li>
                  <li>
                    Internet failures, cyberattacks, or unforeseen regulatory
                    changes.
                  </li>
                </ul>
              </li>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>The security of third-party integrations.</li>
              <li>The availability or performance of blockchain networks.</li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Users must exercise due diligence before engaging in any
                transaction.
              </li>
              <li>
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4 text-base md:text-lg leading-relaxed text-[#080808]">
          <p>
            ...
            interest, judgments, costs, or expenses, including without
            limitation fees and disbursements of counsel, incurred by any
            Indemnified Party arising out of or in connection with or by reason
            of your use of the Services, your breach of applicable laws or
            regulations, and your breach of the representations, warranties or
            covenants set forth herein. Notwithstanding the foregoing, you shall
            not be required to indemnify any Indemnified Party for any loss to
            the extent that that loss is finally determined by a court of
            competent jurisdiction to have arisen solely out of the gross
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4 text-base md:text-lg leading-relaxed text-[#080808]">
          <p>
            The headings contained in these Terms and Conditions are for
      ...
      <section className="space-y-6 border-t pt-8">
        ...
        <div className="space-y-4 text-base md:text-lg leading-relaxed text-[#080808]">
          <p>
            If you have any questions or comments about our Terms and Conditions
            of service as outlined above, please contact us at:
          </p>
