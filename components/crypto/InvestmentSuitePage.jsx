    ...
    >
      <div>
        <div className="max-w-7xl mx-auto">
          ...
          >
            {/* Reduced font weight from font-medium to font-normal */}
            <h2 className="text-4xl sm:text-5xl lg:text-[100px] font-normal text-white mb-4 sm:mb-4">
              Investment suite
            </h2>
            <motion.p
