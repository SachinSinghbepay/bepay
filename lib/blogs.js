...
export async function getAllBlogs() {
  try {
    if (!db) {
      console.warn("Firebase not configured, returning empty blogs array");
      return [];
    }
...
export async function getBlogById(id) {
  try {
    if (!db) {
      console.warn("Firebase not configured, returning null for blog ID");
      return null;
    }
...
export async function getBlogBySlug(slug) {
  try {
    if (!db) {
      console.warn("Firebase not configured, returning null for blog slug");
      return null;
    }
