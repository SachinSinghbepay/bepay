        ...
        <div className="min-h-screen bg-white px-8 py-12">
            <div className="max-w-5xl mx-auto text-[#6A6A6A] leading-relaxed space-y-10">
                ...
                <section className="space-y-6">
                    ...
                    <p>
                        Such information may include your: name including first name and family name, nationality, place of birth, date of birth, street name, street number, street number suffix, postal code, city, country of residence, phone number and email address.
                    </p>
                    ...
                    <ul className="list-disc pl-6 space-y-3">
                        ...
                        <li>
                            Processing is necessary for the purposes of the legitimate interests pursued by the controller or by a third party, except where such interests are overridden by the interests or fundamental rights and freedoms of the data subject which require protection of personal data, in particular where the data subject is a child (refer to Article 6.1(f) GDPR).
                        </li>
                    </ul>

                    <p>
                        If we deem it is necessary, we will process your personal data beyond our contractual obligations in order to protect our legitimate interests or the legitimate interests of a third party.
                    </p>

                    <p>
                        By processing we mean everything we can do with this data such as collecting, recording, storing, adjusting, organizing, using, disclosing, transferring, or deleting.
                    </p>

                    <p>
                        For more information about the way we use your personal data, please refer to Section 4 (What we do with your personal data).
                    </p>

                    <p>
                        You share personal information with us, for example when you: visit our website, complete a(n) (online) (application) form, sign a contract or contact us through one of our channels.
                    </p>

                    <p>
                        We also use data that is legally available from public sources such as commercial registers, the media, or data that is legitimately provided by other companies within the SafeNed Group or by third parties.
                    </p>
                ...
                <section className="space-y-6">
                    ...
                    <h3 className="font-semibold text-black">Administration</h3>
                    <p>
                    ...
                    <h3 className="font-semibold text-black">Managing customer relationships</h3>
                    <p>
                    ...
                    <h3 className="font-semibold text-black">Providing you with the best-suited products and services</h3>
                    <p>
                    ...
                    <h3 className="font-semibold text-black">Improving and developing products and services</h3>
                    <p>
                    ...
                    <h3 className="font-semibold text-black">Preventing and detecting fraud and data security</h3>
                    ...
                    <h3 className="font-semibold text-black">Internal and external reporting</h3>

                    <p>
                        We process your data for our operations and to help our management make better decisions about our operations and services.
                    </p>

                    <p>
                        To comply with a range of legal obligations and statutory requirements (anti-money laundering legislation and tax legislation, for example).
                    </p>
                ...
                <section className="space-y-6">
                    ...
                    <h3 className="font-semibold text-black">Third party service providers</h3>
                    <p>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        ...
                        <li>Preparing reports and statistics, printing materials, and designing products.</li>
                ...
                <section className="space-y-6">
                    ...
                    <h3 className="font-semibold text-black">Right to access information</h3>
                    <p>
                    ...
                    <h3 className="font-semibold text-black">Right to object to automated decisions</h3>
                    <p>
                    ...
                    <h3 className="font-semibold text-black">Right to restrict processing</h3>
                    <p>
                ...
                <section className="space-y-6 text-[#6A6A6A]">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                        ...
                        <li>Do not leave verification tokens or your credit card) unattended.</li>
                        <li>Keep your passwords strictly confidential and use strong passwords, i.e. avoid obvious combinations of letters and figures.</li>
