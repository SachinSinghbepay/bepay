...
<div className="hidden lg:flex items-center justify-start min-h-screen pl-[-25]">
  ...
  <div className="flex-1 max-w-2xl -ml-45">
    <h2 className="font-montserrat font-normal text-[70px] leading-[68px] mb-6">
      <span className="block text-gray-400 tracking-tighter whitespace-nowrap -mt-10">
        Maximise your
      </span>
    ...
    <p className="text-gray-600 text-lg text-[20px] leading-relaxed">
      ...
      <span className="text-black font-medium">
        industry-leading returns and innovative <br/>earning opportunities
      </span>
    </p>
  </div>
</div>
              ...
              <div className="w-full flex flex-col items-center justify-center gap-10 ">
                <div className="relative w-full max-w-[640px] h-[250px] md:h-[250px] lg:h-[370px] lg:ml-150 -mt-17">
                ...
                <div
                    className="lg:ml-150 relative w-full max-w-[640px] h-[250px] md:h-[250px] lg:h-[370px] flex flex-col items-center justify-center text-lg md:text-xl font-medium text-gray-700 bg-gray-50 p-6 rounded-full overflow-hidden"
