...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-black text-white relative overflow-hidden pt-20 px-4 sm:px-6 lg:px-8">
      ...
      >
        {/* CTA Section */}
        <motion.div className="text-center max-w-6xl" variants={itemVariants}>
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <nav className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-xs text-gray-400 tracking-widest uppercase">
        ...
        <motion.div
          className="relative w-full flex justify-center ml-0 -mt-10 mr-0"
