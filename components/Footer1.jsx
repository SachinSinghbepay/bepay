...
const Footer = () => {
  ...
  const DesktopLogo = () => (
    <svg width="1402" height="452" viewBox="0 0 1402 452" fill="none" xmlns="http://www.w3.org/2000/svg" className="hover-logo transition-all duration-500 cursor-pointer max-w-full h-auto" style={{ maxWidth: "1400px", height: "auto" }}>
      <style jsx>{`
          ...
          >
            <div className="space-y-4">
              <div className="space-y-4 lg:space-y-6">
                <Link href="/" className="block text-[#6A6A6A] hover:text-gray-400 transition-colors">PERSONAL</Link>
                <Link href="/business" className="block text-[#6A6A6A] hover:text-gray-400 transition-colors">BUSINESS</Link>
                <Link href="/bepay-foundations" className="block text-[#6A6A6A] hover:text-gray-400 transition-colors">BEPAY FOUNDATIONS</Link>
              </div>
            </div>
            <div className="space-y-4">
              <div className="space-y-4 lg:space-y-6">
                <Link href="/about-us" className="block text-[#6A6A6A] hover:text-gray-400 transition-colors">ABOUT US</Link>
                <Link href="/contact-us" className="block text-[#6A6A6A] hover:text-gray-400 transition-colors">CONTACT US</Link>
                <Link href="/privacy-policy" className="block text-[#6A6A6A] hover:text-gray-400 transition-colors">PRIVACY POLICY</Link>
              </div>
            </div>
            <div className="space-y-4">
              <div className="space-y-6 lg:space-y-6">
                <Link href="/delete-account" className="block text-[#6A6A6A] hover:text-gray-400 transition-colors">ACCOUNT DELETION FORM</Link>
                <Link href="/privacy-policy-for-deleting-user-account" className="block uppercase text-[#6A6A6A] hover:text-gray-400 transition-colors">for deleting user account</Link>
                <Link href="/privacy-policy-for-deleting-merchant-account" className="block uppercase text-[#6A6A6A] hover:text-gray-400 transition-colors ">for deleting merchant account</Link>
              </div>
            </div>
            <div className="space-y-4">
              <div className="space-y-5 lg:space-y-6">
                <Link href="/terms-and-conditions" className="block text-[#6A6A6A] hover:text-gray-400 transition-colors">TERMS & CONDITIONS</Link>
                <Link href="/legal-disclamer" className="block uppercase text-[#6A6A6A] hover:text-gray-400 transition-colors">Legal disclaimer</Link>
                <Link href="/cookie-policy" className="block uppercase text-[#6A6A6A] hover:text-gray-400 transition-colors">Cookie Policy</Link>
              </div>
            </div>
          </motion.div>
        </motion.div>
