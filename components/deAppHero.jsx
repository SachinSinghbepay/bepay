...
const DAppCard = ({ iconUrl, name, tag }) => (
...
const DAppListItem = ({ iconUrl, name, tag, description }) => (
  <div className="flex items-center space-x-4 bg-gray-50 rounded-2xl p-3">
    ...
    <a href="#" className="flex-shrink-0 bg-white p-2 rounded-lg shadow-sm hover:bg-gray-100 transition"><ArrowUpRight size={20} className="text-gray-600" /></a>
  </div>
);
...
const DAppPage = () => {
  const featuredDapps = [
    { name: 'VVS Finance', tag: 'DEX', iconUrl: '/icons/VVS.svg' },
    { name: 'Moon-lander', tag: 'DEX', iconUrl: '/icons/moon_lander.svg' },
    { name: 'Uniswap',     tag: 'DEX', iconUrl: '/icons/uniswap.svg' },
    { name: 'Jupiter',     tag: 'DEX', iconUrl: '/icons/jupiter.svg' },
    { name: 'AAVE',        tag: 'Lending', iconUrl: '/icons/aava.svg' },
  ];
  
  const dAppList = [
    { name: 'Hyperliquid bridge', tag: 'Bridge', description: 'Hyperliquid is a decentralized perp...', iconUrl: '/icons/hyperliquid.svg' },
    { name: 'Aave', tag: 'Lending', description: 'Aave is an open source and non-cu...', iconUrl: '/icons/aava.svg' },
    { name: 'Jupiter', tag: 'DEX', description: 'Best exchange in DeFi. Full stack...', iconUrl: '/icons/jupiter.svg' },
    { name: 'Morpho', tag: 'Lending', description: 'Morpho is a permissionless decent...', iconUrl: '/icons/morpho.svg' },
    { name: 'EigenLayer', tag: 'Staking', description: 'EigenLayer is a protocol built on Eth...', iconUrl: '/icons/layer.svg' },
    { name: 'Lido', tag: 'Staking', description: 'Liquid staking for Ethereum and Pol...', iconUrl: '/icons/liquid.svg' },
    { name: 'Jito', tag: 'Staking', description: 'Jito network powers the Solana ec...', iconUrl: '/icons/jito.svg' },
  ];
