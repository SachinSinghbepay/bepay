    ...
    >
      ...
      >
            ...
            <div className="flex flex-col p-4 pb-8 flex-grow space-y-3">
              ...
              <div className="flex items-center gap-2">
                <Image
                  ...
                  alt="Keys and Crypto"
                />
                {/* MODIFICATION: Changed text size to text-xs */}
              ...
              <div className="mt-8">
                <WaitlistTriggerButton>
                  <button className="bg-black cursor-pointer -mt-5 whitespace-nowrap text-white px-6 h-[56px] rounded-full flex items-center justify-center gap-2 text-xs font-medium hover:bg-gray-800 transition-colors">
                    <Image
                      src="/businessnew/buttonIcon.png"
                      alt="Create Wallet"
                      width={20}
        ...
        <div className="flex flex-col h-full">
          ...
          {/* MODIFICATION: Increased top margin to push content down */}
          <div className="flex flex-col p-4 pb-8 flex-grow space-y-3 mt-2">
            {/* MODIFICATION: Reduced negative margin to push heading down */}
            ...
            {/* MODIFICATION: Increased top margin to push CTA down */}
            <div className="mt-0">
              <WaitlistTriggerButton>
                <button className="bg-black mt-2 cursor-pointer whitespace-nowrap text-white px-6 h-[56px] rounded-full flex items-center justify-center gap-2 text-xs font-medium hover:bg-gray-800 transition-colors">
                  <Image
                    src="/businessnew/virtual5.svg"
                    alt="Get Card"
                    width={20}
        ...
        <div className="mobile-card w-[90vw] h-[88vh] flex-shrink-0 bg-white rounded-[1.5rem] shadow-lg overflow-hidden">
          <div className="flex flex-col h-full">
            ...
            <div className="flex flex-col p-4 pb-8 flex-grow space-y-3">
              ...
              <div className="mt-8">
                <WaitlistTriggerButton>
                  <button className="bg-black cursor-pointer -mt-6 whitespace-nowrap text-white px-6 h-[56px] rounded-full flex items-center justify-center gap-2 text-xs font-medium hover:bg-gray-800 transition-colors">
                    <Image
                      src="/businessnew/IBAN6.svg"
                      alt="Get account"
                      width={20}
