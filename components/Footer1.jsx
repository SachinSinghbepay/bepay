...
const Footer = ({ heading, headingSize = "text-[24px]", isUpiPage = false }) => {
            ...
            {isUpiPage ? (
              <>
                ...
                <div className="space-y-4">
                    ...
                    <Link href="/bepay-foundations" onClick={() => handleLinkClick("Bepay Foundation")} className="block text-[#7A7A7A] hover:text-gray-400 transition-colors">
                        BEPAY FOUNDATION
                    </Link>
                ...
                <div className="space-y-4">
                    ...
                    <Link href="/terms-and-conditions" onClick={() => handleLinkClick("Terms & Conditions")} className="block text-[#7A7A7A] hover:text-gray-400 transition-colors">
                        TERMS & CONDITIONS
                    </Link>
                    <Link href="/legal-disclamer" onClick={() => handleLinkClick("Legal Disclaimer")} className="block uppercase text-[#7A7A7A] hover:text-gray-400 transition-colors">
                        LEGAL DISCLAIMER
                    </Link>
                </div>
