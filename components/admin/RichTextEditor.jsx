...
const MenuBar = ({ editor }) => {
  ...
  return (
    <div className="flex flex-wrap gap-1 rounded-t border border-black bg-gray-50 p-2">
      <button
        onClick={() => editor.chain().focus().toggleBold().run()}
        className={`rounded p-1 ${editor.isActive("bold") ? "bg-gray-200" : ""}`}
        title="Bold"
      >
      ...
      <button onClick={addImage} className="rounded p-1" title="Image" disabled={isUploading}>
      ...
      {showLinkInput && (
        <div className="ml-2 flex items-center">
          ...
          />
          <button onClick={setLink} className="ml-1 rounded bg-black px-2 py-1 text-sm text-white">
            Set
          </button>
          <button
            onClick={() => {
