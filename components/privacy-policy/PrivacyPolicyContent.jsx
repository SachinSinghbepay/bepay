      ...
      <section className="space-y-6">
        ...
        <div className="space-y-6 text-base md:text-lg leading-relaxed text-[#080808]">
          ...
          <div className="space-y-4">
            ...
            <p>
              Many of the websites you visit place small, encrypted text files
              on your device (smartphone, computer, or tablet). We call these
              text files cookies. BEPAY MONEY uses cookies or similar techniques
              whenever you interact with our website. A cookie is sent by a web
              server to a web browser that enables the server to collect
              information back from the browser creating connectivity between a
              company and the customer. In other words, the cookies on the
              websites (and some e-mails) store small amounts of information on
              your device to allow browser information from your web browser to
              be collected. This information could be used to make it easier for
              you to use the website or for marketing purposes. Cookies generally
              process your IP-address, but they do not save your personal
              information such as your e-mail address or phone number (only if
              you give us permission to act in this manner). Above all, cookies
              allow websites to monitor website visitor&apos;s behavior.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              issues caused by cookie tracking is by including clear
              descriptions of how cookies are deployed on their site (informed
              consent). The cookies our website uses falls into the following
              three categories:
            </p>

            <div className="space-y-4">
              <h4 className="text-lg font-semibold">1. Functional cookies</h4>
              <p>
                These cookies may store your browser name, the type of computer
                ...
                Providers utilized and other similar information. BEPAY MONEY
                uses this information to technically facilitate the visitors of
                this website. In addition, functional cookies may be used to
                store personal settings, such as language or to log your
                information for next visits to save you the trouble of having to
                change these every time you enter our website. To conclude, our
                website could not work properly without these cookies.
              </p>
            </div>

            <div className="space-y-4">
              <h4 className="text-lg font-semibold">2. Analytical cookies</h4>
              <p>
                BEPAY MONEY uses cookies to help us understand and improve the
                customer experience on our website. We use Google Analytics, a
                web analysis service, to generate statistical and other
                analytical information to learn about visitor preferences and
                provide them with the right information more quickly. The goal
                is to provide much greater functionality to visitors. Therefore,
                we also examine whether visitors experience any forms of errors
                or inaccuracies on the website. We use the analytical cookies
                also to test different designs and features for our sites. All
                information is collected in a pseudonymized or anonymized form.
              </p>
            </div>

            <div className="space-y-4">
              <h4 className="text-lg font-semibold">3. Marketing cookies</h4>
              <p>
                This website contains cookies from third-party websites, mainly
                social media cookies. When placed on your computer, they
                automatically activate handy extras, for example, to share
                information on LinkedIn or HubSpot. These cookies inform our
                website whether you are logged into such social media and they
                also make it easy for you to share pages on social media or to
                display social content about a topic (content timeline LinkedIn,
                for instance). If you would like to know more about how these
                social media platforms use data, please refer to the privacy
                notices of these platforms. When visiting this website, BEPAY
                MONEY will ask for your consent to use these cookies. In other
                words, we only place advertising, marketing and social media
                cookies if you give us your permission to do this.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              To see what cookies have been set and how to manage, block and/or
              delete them, please read this subsection on how you object to
              cookies. If you do not want to have cookies stored on your
              computer or want to remove cookies that have already been stored,
              you can change settings, at any time on this website by clicking
              the change cookie settings on the cookie button on the homepage.
              Another option is to arrange the settings (privacy &amp; security)
              in your web browser. This so-called &quot;Do Not Track&quot; is a function
              that allows visitors not to be tracked by websites.
            </p>
            ...
            <p>
              The advantage of this method is that consumers are less likely to
              be confronted with cookie banners (a pop-up that appears when a
              visitor comes to a website), which improves your browsing
              experience.
            </p>
          </div>
        </div>
