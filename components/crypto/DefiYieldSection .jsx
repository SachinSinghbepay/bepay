...
>
  ...
  <p className="text-sm md:text-sm text-gray-600 leading-relaxed w-full md:w-[70%]">
    Earn by sharing your unused storage and computing power.
  </p>
  <p className="text-sm md:text-sm italic text-gray-800 leading-relaxed w-full md:w-[70%]">
