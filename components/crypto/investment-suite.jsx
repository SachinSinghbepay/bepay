...
export default function InvestmentSuite() {
  ...
  <motion.button
    ...
    className="flex items-center justify-center gap-3 -mt-6 md:mt-0 self-start w-[221px] h-[56px] cursor-pointer whitespace-nowrap bg-white text-black rounded-full text-lg font-normal hover:bg-gray-100 transition-colors"
  >
    <svg
      width="24"
      height="24"
